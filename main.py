...
API_KEY_ESTUDIANTES = "dcbc8129-7df3-4607-9715-ad01ec5f8724"
API_KEY_ADMINISTRATIVOS = "79bcb6ef-c023-4ca1-98c5-8c244c2e0a3c"
...
@app.route('/estudiante/<string:keyEstudiante>/<string:usuario>', methods=['GET'])
def get_estudiantes(usuario, keyEstudiante):

    if(keyEstudiante == API_KEY_ESTUDIANTES):
...
@app.route('/administrativo/<string:keyAdmin>/<string:identificacion>', methods=['GET'])
def get_administrativo(identificacion, keyAdmin):

    if(keyAdmin == API_KEY_ADMINISTRATIVOS):
